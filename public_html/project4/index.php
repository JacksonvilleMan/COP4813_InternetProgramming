...
{	
    ...
    if(movieExistsInDB($imdbID) == 0)
    {
        ...
        echo addMovie($movieInfo["imdbID"],$movieInfo["Title"],$movieInfo["Year"],$movieInfo["Rated"],$movieInfo["Runtime"],$movieInfo["Genre"],$movieInfo["Actors"],$movieInfo["Director"],$movieInfo["Writer"],$movieInfo["Plot"],$movieInfo["Poster"]);
    }
...
{
    $_SESSION["cart"] = getMoviesInCart($_SESSION["userId"]);
